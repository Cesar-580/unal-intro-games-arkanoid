...
public class BlockTile : MonoBehaviour
{
    ...
    private void  SpawnPowerUps(ContactPoint2D contactPoint)
    {
        if(Random.value<0.5f)
        {
            ...
            if(randomPUp<0.15f)
            {
                Instantiate(Resources.Load<GameObject>("Prefabs/PowerUp_S"),contactPoint.point,Quaternion.identity);
            }
            else if(randomPUp<0.3f)
            {
                Instantiate(Resources.Load<GameObject>("Prefabs/PowerUp_F"),contactPoint.point,Quaternion.identity);
            }
            else if(randomPUp<0.45f)
            {
                Instantiate(Resources.Load<GameObject>("Prefabs/PowerUp_E"),contactPoint.point,Quaternion.identity);
            }
            else if(randomPUp<0.6f)
            {
                Instantiate(Resources.Load<GameObject>("Prefabs/PowerUp_A"),contactPoint.point,Quaternion.identity);
            }
            else if(randomPUp<0.7f)
            {
                Instantiate(Resources.Load<GameObject>("Prefabs/PowerUp_50"),contactPoint.point,Quaternion.identity);
            }
            else if(randomPUp<0.8f)
            {
                Instantiate(Resources.Load<GameObject>("Prefabs/PowerUp_100"),contactPoint.point,Quaternion.identity);
            }
            else if(randomPUp<0.9f)
            {
                Instantiate(Resources.Load<GameObject>("Prefabs/PowerUp_250"),contactPoint.point,Quaternion.identity);
            }
            else if(randomPUp<=1f)
            {
                Instantiate(Resources.Load<GameObject>("Prefabs/PowerUp_500"),contactPoint.point,Quaternion.identity);
            }
